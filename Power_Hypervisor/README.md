...
## Goal
The goal of the Power Hypervisor is to always be listening for socket connections and then once accepted perform SSL/TLS checks to ensure it is a trusted device before it can perform any actions on the server. 
